...
static ERL_NIF_TERM
gen_key_pair_from_seed(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
...
static ERL_NIF_TERM
enc(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
...
static ERL_NIF_TERM
dec(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
...
static ErlNifFunc nif_funcs[] = {
    ...
    {"gen_key_pair_from_seed", 1, gen_key_pair_from_seed},
    {"enc", 1, enc},
    {"dec", 2, dec}};
